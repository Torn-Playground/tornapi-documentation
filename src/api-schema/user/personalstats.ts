...
const personalStatsStructure: Structure = {
    ...
    schema: {
        ...
        bazaarcustomers: { type: Integer, description: "Bazaar customers" },
        bazaarprofit: { type: Integer, description: "Bazaar income" },
        bazaarsales: { type: Integer, description: "Bazaar sales" },
        itemmarketsales: { type: Integer, description: "Item Market 2.0 sales" },
        itemmarketcustomers: { type: Integer, description: "Item Market 2.0 customers" },
        itemmarketrevenue: { type: Integer, description: "Item Market 2.0 income" },
        itemmarketfees: { type: Integer, description: "Item Market 2.0 fees" },
