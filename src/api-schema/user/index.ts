...
import CriminalRecordSelection from "@/api-schema/user/criminalrecord";
...
import EquipmentSelection from "@/api-schema/user/equipment";
...
import HonorsSelection from "@/api-schema/user/honors";
